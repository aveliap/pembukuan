  ...
  <form role="form">
    <div class="box-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="invoice" name="invoice" placeholder="Invoice"  required>
      </div>
      <div class="form-group">
        <label for="id_tipe">Paket Laundry</label>
        <select class="form-control" id="detLaundry_id" name="detLaundry_id" onchange="">
          @foreach ($laundry as $pktlaundry)
            <option value="{{ $pktlaundry -> id }}">
              {{$pktlaundry -> nama_laundry}}
            </option>
          @endforeach
        </select>
      </div>
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="total_kilo" name="total_kilo" placeholder="Jumlah Kilo" >
      </div>
      <div class="form-group">
      ...
      <!-- <div class="form-group">
        ...
        <input type="text" class="form-control" id="harga" name="harga" readonly="readonly" value="0">
      </div>
      <div class="form-group">
        <label for="exampleInputPassword1">Total</label>
        <input type="text" class="form-control" id="Total" name="Total" readonly
        value="{{$data->laundry->harga ?? ''}}">
      </div> -->
    <!-- /.box-body -->
